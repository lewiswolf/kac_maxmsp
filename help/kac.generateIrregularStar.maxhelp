		...
		"boxes": [
						...
						"boxes": [
							...
							},
							{
								"box": {
									...
									"numoutlets": 2,
									"outlettype": ["", ""],
									"patching_rect": [50.0, 342.0, 597.0, 22.0],
									"text": "jit.gl.sketch @drawto irregular-star-polygon-helpfile-1 @gl_color 0. 0. 0. 0. @line_width 1.5 @position 0. 0. -0.5"
								}
							},
							{
								"box": {
			...
			},
			{
				"box": {
					...
					"id": "obj-15",
					"maxclass": "jit.pworld",
					"name": "irregular-star-polygon-helpfile-1",
					"numinlets": 1,
					"numoutlets": 2,
			...
			},
			{
				"box": {
					...
					"patching_rect": [417.4392524957657, 317.0, 90.0, 22.0],
			...
			},
			{
				"box": {
					...
					"numoutlets": 1,
					"outlettype": [""],
					"patching_rect": [650.0, 351.0, 118.00000101327896, 49.0],
					"text": "0. 0.33991 0.589829 0.66009 1. 0.33991"
				}
			},
			{
				"box": {
			...
			},
			{
				"box": {
					...
					"text": "-0.398802 -0.103691 0.398802 -0.624497 -0.275462 0.624497"
				}
			},
			{
				"box": {
		...
		"lines": [
			...
			},
			{
				"patchline": {
					...
					"midpoints": [426.9392524957657, 309.2999997437, 758.500001013279, 309.2999997437],
					"order": 0,
					"source": ["obj-4", 0]
				}
			},
